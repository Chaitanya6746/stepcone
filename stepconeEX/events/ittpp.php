    ...
    <div class="row">
        <div class="col-lg-7 col-md-12 col-sm-12 content" data-aos="fade-right">
            <p>
                ...
                <li>1.&nbsp;&nbsp;Machine learning algorithms</li>
                <li>2.&nbsp;&nbsp;Predictive modelling</li>
                <li>3.&nbsp;&nbsp;Computational complexity and optimization</li>
               <li>4.&nbsp;&nbsp;Next-Generation Communication Technologies</li>
                <li>5.&nbsp;&nbsp;Wireless Sensor Networks</li>
                <li>6.&nbsp;&nbsp;Machine to Machine Communication</li>
                <li>7.&nbsp;&nbsp;Virtualization and Cloud Computing</li>
                <li>8.&nbsp;&nbsp;Data Privacy and Security </li>
                <li>9.&nbsp;&nbsp;Blockchain Technology</li>
                <li>10.&nbsp;&nbsp;IoT Privacy and Security Concerns, IoT forensic Science</li>
                <li>11.&nbsp;&nbsp;Intelligent computing for intelligent systems</li>
                <li>12.&nbsp;&nbsp;Machine learning and deep learning</li>
               </ol>
