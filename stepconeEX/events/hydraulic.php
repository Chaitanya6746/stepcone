...
<head>
    ...
    <style>
        .event-title {
            padding-top: 30vh;
            padding-bottom: 30vh;
            background: url("image/hydraulic.png") no-repeat;
...
<body>
    ...
    <div class="row event" data-aos="fade-right">
        <h3>HYDRAULIC PROPULSION</h3>
    </div>
    <div class="row">
        <div class="col-lg-7 col-md-12 col-sm-12 content" data-aos="fade-right">
            <p align="justify">It is an event where we used “HYDRAULIC PROPULSION” mechanism for boat making.
            ...
            <div class="buttons" data-aos="fade-up">
                <a href="../eventRegistration.php?event=334"><button>register</button></a>
        ...
        <div class="col-lg-5 col-md-12 col-sm-12 tools">
            <div class="box" data-aos="fade-right" data-aos-duration="1000">
                <div class="text">prize money:<br>winner-Rs 40,000/-<br>runner-Rs 25,000/-</div>
            </div>
            <div class="box" data-aos="fade-right" data-aos-duration="1000">
        ...
        <div class="co">FACULTY COORDINATORS</div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/men.png" alt="">Mr . Raviteja karanam<br>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/men.png" alt="">Mr. B. Priyatham<br>
            </div>
        ...
        <div class="co">COORDINATORS</div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/TEAM/Jagadeeswari.jpg" alt="">M.Jagadeeswari<br><a href="tel:8790567458">8790567458</a>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/TEAM/Billgates.jpg" alt="">P.BILGATES<br><a href="tel:8008105592">8008105592</a>
            </div>
