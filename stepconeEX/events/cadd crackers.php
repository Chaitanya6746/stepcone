...
<head>
    ...
    <style>
        .event-title {
            padding-top: 30vh;
            padding-bottom: 30vh;
            background: url("image/cadd\ crackers.png") no-repeat;
            background-size: 100%;
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-12 col-sm-12 tools">
            <div class="box" data-aos="fade-left" data-aos-duration="1000">
                <div class="text">prize money:<br>winner-Rs 10,000/-<br>runner-Rs 6,000/-<br>3rd prize-4000/-</div>
            </div>
            <div class="box" data-aos="fade-left" data-aos-duration="1000">
        ...
        <div class="row person">
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/women.png" alt="">Dr. P.N.S .Pavani<br>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/men.png" alt="">Mr. Pandi mani<br>
            </div>
        </div>
        <br><br><br>
        ...
        <div class="row person">
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/men.png" alt="">K. DIVAKAR<br><a href="tel:9876543210">9876543210</a>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/men.png" alt="">R. MOHAN KUMAR<br><a href="tel:9876543210">9876543210</a>
            </div>
        </div>
    </div>
    <br><br>
