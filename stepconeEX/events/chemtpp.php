...
<body>
    ...
    <div class="row event-title">
        ...
        <div class="col-8 t" data-aos="zoom-out" data-aos-duration="2000">
            <p>CHEMICAL PAPER PRESENTATION</p>
        </div>
        <div class="col-2"></div>
    </div>
    <div class="container">
    ...
    <div class="row">
        <div class="col-lg-7 col-md-12 col-sm-12 content" data-aos="fade-right">
            <p>
                <ol>
                    <li>1.&nbsp;&nbsp;&nbsp;sustainable nano technologies</li>
                    <li>2.&nbsp;&nbsp;&nbsp;carbon capture in sequestration</li>
                    <li>3.&nbsp;&nbsp;&nbsp;Fuel and battery technology</li>
                    <li>4.&nbsp;&nbsp;&nbsp;Sustainable engery and Environment technology</li>
                    <li>5.&nbsp;&nbsp;&nbsp;Environment friendly materials</li>
                    <li>6.&nbsp;&nbsp;&nbsp;Role of AL and ML in chemical engineering</li>
                    <li>7.&nbsp;&nbsp;&nbsp;Explain the Automation in chemical industry in future</li>
                    <li>8.&nbsp;&nbsp;&nbsp;Pinch Technology</li>
                    <li>9.&nbsp;&nbsp;&nbsp;Seperation Technology</li>
                    <li>10.&nbsp;&nbsp;&nbsp;Stimulation and Design of chemical process</li>
                    <li>11.&nbsp;&nbsp;&nbsp;Waste to wealth technology</li>
                    <li>12.&nbsp;&nbsp;&nbsp;Chemical process scale up</li>
                    <li>13.&nbsp;&nbsp;&nbsp;Biochemical process</li>
                    <li>14.&nbsp;&nbsp;&nbsp;Alternative energy technology</li>
                    <li>15.&nbsp;&nbsp;&nbsp;Energy harvesting</li>
