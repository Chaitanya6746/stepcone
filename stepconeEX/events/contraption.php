...
<head>
    ...
    <style>
        .event-title {
            padding-top: 30vh;
            padding-bottom: 30vh;
            background: url("image/contaption.jpeg") no-repeat;
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-12 col-sm-12 tools">
            <div class="box" data-aos="fade-right" data-aos-duration="1000">
                <div class="text">prize money:<br>winner-Rs 9,000/-<br>runner-Rs 6,000/-</div>
            </div>
            <div class="box" data-aos="fade-right" data-aos-duration="1000">
                <div class="text">team size:<br>1-4 members</div>
            </div>
            <div class="box" data-aos="fade-right" data-aos-duration="1000">
                <div class="text">registration fee:<br>Rs 4000/-</div>
            </div>
        </div>
        ...
        <div class="co">COORDINATORS</div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/TEAM/jhansi_small.jpg" alt="">B.Jhansi rani<br><a href="tel:8309565487">8309565487</a>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/TEAM/kushwanth.jpeg" alt="">A.Kushwanth<br><a href="tel:9014582146">9014582146</a>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-4 profile" data-aos="zoom-in">
                <img src="image/men.png" alt="">B. Vasu<br><a href="tel:9010134226">9010134226</a>
            </div>
        </div>
    </div>
    <br><br>
